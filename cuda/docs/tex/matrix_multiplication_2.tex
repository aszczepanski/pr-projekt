...
\begin{figure}[H]
  ...
  \end{tabular}
  \captionlistentry{Czas obliczeń [ms] -- wersja 2.}
  }
...
\begin{figure}[H]
  ...
  \end{tabular}
  \captionlistentry{Ilosc operacji zmiennoprzecinkowych na sekundę (GFLOPS) -- wersja 2.}
  }
...
\begin{figure}[H]
  ...
  \end{tabular}
  \captionlistentry{Ilość instrukcji wykonana na sekundę (GIPS) -- wersja 2.}
}
